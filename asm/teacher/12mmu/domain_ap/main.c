...
#define create_descriptor(ttb, va, pa, ap) \
		ttb[va >> 20] = (pa & 0xfff00000) | 0x12 | ap

void section_map(u32 *ttb, u32 va_start, u32 va_end, u32 pa)
{
	while(va_start < va_end)
	{
		create_descriptor(ttb, va_start, pa, 0);
...
int main(void)
{
	...
	create_descriptor(ttb, 0x70000000, 0x32000000, 0x1e0 | 0xc00);
